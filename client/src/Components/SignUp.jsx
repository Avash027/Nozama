...
const SignUp = ({signUpSelected ,
  ...
  return (
        ...
        <div className="clearfix">
          ...
          style={{width:"100%" , marginBottom:"1rem"}}>{loading?"Loading":"SignUp"}</button>
          <button type="button" onClick={()=>history.push("/")} className="cancelbtn warning-button">Cancel</button>
